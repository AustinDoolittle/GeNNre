...
flags="--target 0.0001  --interval 20 --benchmark --inputcount 11 --timeout 750"
...
./NN.out --trainfile $dataset_dir/9train_norm_data.dat --testfile $dataset_dir/9test_norm_pca_data.dat $flags --outputcount 9 --diverge 4 
